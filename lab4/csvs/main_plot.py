...
# plt.plot(df1.iloc[0:14, 2], df1.iloc[0:14, 4], ".-")
# plt.plot(df1.iloc[14:28, 2], df1.iloc[14:28, 4], ".-")
# plt.plot(df1.iloc[28:42, 2], df1.iloc[28:42, 4], ".-")
# plt.plot(df1.iloc[42:56, 2], df1.iloc[42:56, 4], ".-")
# plt.plot(df1.iloc[56:70, 2], df1.iloc[56:70, 4], ".-")
